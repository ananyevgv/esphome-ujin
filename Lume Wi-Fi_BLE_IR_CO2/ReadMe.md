# Модели Lume Wi-Fi_BLE_IR_CO2 Pulse Wi-Fi_BLE_IR_CO2 и им подобные
...
Средняя кнопка выключателя задублирована на 1 кнопку (можно сделать одноклавишный вариант, и на оборот)

На некоторых платах нет линейного стабилизатора на 3.3в (установлен в ответной части) для прошивки необходимо запитывать по 3.3В
